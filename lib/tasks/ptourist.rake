namespace :ptourist do
  ...
  task subjects: [:users] do
    ...
    :notes=>"Trains rule, boats and cars drool", thing_type: 'museum'}
    ...
    :notes=>"No on-duty pirates, please", thing_type: 'tour'}
    organizer=get_user("alice")
    members=boy_users
    images=[
    ...
    :notes=>"Bus is clean and ready to roll", thing_type: 'tour'}
    ...
    :notes=>"Early to bed, early to rise", thing_type: 'accommodation'}
    ...
    :notes=>"Remember to water the fish", thing_type: 'aquarium'}
    organizer=get_user("carol")
    members=girl_users
    images=[
